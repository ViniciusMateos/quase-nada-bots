...
//
// Não confundir com:
//   - `version` no package.json/app.config → versão de marketing do app
//   - `runtimeVersion` fixo → compatibilidade OTA×nativo (só muda em build)
export const OTA_VERSION = 21;
